...
Derniere mise a jour: 2026-06-17 01:05 UTC
...
- [ ] GitOps pousse par l'automatisation apres correction du lint Terraform.
...
- Validation artefacts: `scripts/publish-artifacts.sh` a publie `kubeupgrade-guardian-operator`, `upgrade-lab/edge-api`, `upgrade-lab/catalog-service`, `upgrade-lab/orders-service`, `upgrade-lab/signals-service`, `helm/kubeupgrade-guardian-operator` et `helm/upgrade-lab` en tag `0.1.0` dans ACR.
