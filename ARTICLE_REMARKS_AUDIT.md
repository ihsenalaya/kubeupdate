...
Update after R10/R04 pass: the article now includes managed AKS validation run `20260617T101556Z`, multi-cluster AKS execution, runtime/resource/API-counter profiling, provider-observation separation, R10 adversarial control-label results, AKS scale boundary results, scoring sensitivity, early scope/non-claims, CRD security discussion, checker interaction discussion, scalability limits, documentation strategy, and related-tool positioning. The remaining substantive non-claim is external expert-rated `UpgradePlan` actionability: the review packet exists, but independent expert ratings have not been collected and must not be claimed.
...
| R03 | Complete | Claims/evidence table includes local, controlled, managed, R10, scale-boundary, and explicit non-claim evidence rows. | Conforme |
| R04 | Complete | Scope boundaries and claims/evidence table separate managed validation, R10 controls, scale boundary, agent exclusion, and expert review non-claim. | Conforme |
...
| R10 | Complete | Article now contains measured benchmark results, R10 adversarial control-label results, baseline split, negative controls, execution time, and scale-boundary failure analysis. | Conforme |
...
| R36 | Complete | Article reports assessment wait, API deltas, pod RSS where available, and local controller RSS samples for scale failures. | Conforme |
| R37 | Complete | Error analysis now includes scenario FP/FN, negative controls, provider observations, measurement ambiguity, artifact scalability failure, and R10 false-negative categories. | Conforme |
...
| R43 | Complete | Article reports 100/1,000/5,000/10,000 AKS scale boundary results and the `Request entity too large` status persistence limit. | Conforme |
...
- Conforme after R10/R04 pass: R01, R02, R03, R04, R06, R07, R08, R09, R10, R11, R12, R13, R14, R15, R16, R17, R20, R23, R24, R25, R26, R27, R28, R29, R30, R31, R32, R33, R34, R35, R36, R37, R38, R39, R40, R42, R43, R44.
...
Priority for the next article pass: redesign scalable result storage, collect external expert ratings, replace R10 control labels with independent human labels, and strengthen close academic Kubernetes upgrade/evolution related work.
